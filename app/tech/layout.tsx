...
export default function TechLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-screen flex-col pb-16">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
        <Link
          href="/tech"
          className="flex min-h-14 items-center justify-center gap-2 text-sm font-medium"
        >
